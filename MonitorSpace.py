...
#Step01 - Split the file input in two txt temp files

#Line Separator
delimiter = '"SUMMARY OF DATA SETS BY VOLUME REPORT"'
with open(r'yourpathinyourPC) as spacemonitor:
...
with open(r'yourpathinyourPC, "w") as spacemonitor:
...
with open(r'yourpathinyourPC, "r+") as spacemonitor:
...
#Step 3 - Remove all lines after the delimiter2
...
import pandas as pd
spacemonitor1df = pd.read_csv(r'yourpathinyourPC, delim_whitespace = True, on_bad_lines='skip',header=None)
...
spacemonitor1df.to_csv(r'yourpathinyourPC',index=False,sep='|')


#Step8 - Creates a dataframe for spacemonitor2 and modifies it as necessary
spacemonitor2df = pd.read_csv(r'yourpathinyourPC, delim_whitespace = True, on_bad_lines='skip',header=None)
